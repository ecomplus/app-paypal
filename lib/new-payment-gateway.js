...
const onloadScriptfile = path.join(__dirname, '../assets/express-checkout/onload-expression.js')
...
module.exports = lang => {
  ...
  return {
    ...
    icon: 'https://paypal.ecomplus.biz/assets/express-checkout/icon.png',
    js_client: {
